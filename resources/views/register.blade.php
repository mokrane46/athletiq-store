@extends('layouts.app')
@section('title', 'SIGN UP | Athletiq')
@section('styles')
<style>
    .auth-page {
...
<main class="auth-page">
    ...
    <div class="auth-container">
        ...
        <div class="auth-header">
            <h2 class="auth-title">JOIN THE ELITE</h2>
            <p class="auth-sub">Create your account to unlock your full potential.</p>
        </div>
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('register.post') }}" class="auth-form">
            ...
            <button type="submit" class="premium-btn auth-submit">Sign Up</button>
        </form>
        <div class="auth-footer">
            <p>Already in the squad? <a href="{{ route('login') }}">Sign In</a></p>
        </div>
    </div>
</main>
@endsection
