...
path = r"c:\Users\Amine mokrane\OneDrive - Aston University\Desktop\myApp 1\myApp\public\js\script.js"

with open(path, 'r', encoding='utf-8') as f:
    js = f.read()

# We need to wrap everything except Theme Toggle and Hero animation in if (navbar)
safe_js = """
